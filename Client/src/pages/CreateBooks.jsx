...
const CreateBooks = () => {
  ...
  return (
    <div className='p-4'>
      ...
      {loading ? <Spinner /> : ''}
      <div className='flex flex-col border-2 border-sky-600 rounded-xl w-[640px] p-4 mx-auto shadow-lg'>
        <div className='my-4'>
        ...
        <button className='p-2 bg-sky-400 m-8 font-bold rounded' onClick={handleSaveBook}>
          Create
        </button>
      </div>
    </div>
